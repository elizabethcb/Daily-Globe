    ...
    <form action="" method="post" accept-charset="utf-8">      
      ...
      <ul id="options">
        ...
        <li>
          ...
          <p class="note"><?php printf(__('The path %s must exist, be writable by the server and accessible through browser.', 'wpomatic'), '<span id="cachepath">'. $this->cachepath . '<span id="cachepath_input">' . get_option('wpo_cachepath') . '</span></span>') ?></p>                 
        </li>
      </ul>     
