<?php defined('FU_PLUGIN_DIR_PATH') or exit('No direct script access. FrontUsers Template');
/**
 * Events Template
 *
...
class FrontUsers_Template {
	 ...
	 * @return  object  FrontUsers_Template
	 */
	public function factory($file = NULL)
	{
		return new FrontUsers_Template($file);
	}
	...
	public function set($key, $value = NULL) {
		...
		if ($value instanceof FrontUsers_Template) {
