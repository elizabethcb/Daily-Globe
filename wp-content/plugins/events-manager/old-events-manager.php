<?php
/*
Pugin Name: Events Manager
Vrsion: 2.0rc2
Pugin URI: http://davidebenini.it/wordpress-plugins/events-manager/
Dscription: Manage events specifying precise spatial data (Location, Town, Province, etc).
Athor: Davide Benini, Marcus Skyes
Athor URI: http://www.davidebenini.it/blog
*/
...
define('DBEM_URI', get_bloginfo('url') . '/wp-content/plugins/events-manager/' );
define('DBEM_ADMIN_URI'), DBEM_URI . 'admin/');
