...
class SyndicatedPost {
	...
	function SyndicatedPost ($item, $link) {
		...
		if (is_null($this->item)) :
			...
			$this->post['post_title'] = trim(apply_filters('syndicated_item_title', $this->item['title'], $this));
			...
			$this->post['named']['author'] = trim(apply_filters('syndicated_item_author', $this->author(), $this));
