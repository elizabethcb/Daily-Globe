...
class WPOMatic {               
  ...
  {              
    ...
    # Actions
    add_action('activate_wp-o-matic-orig/wpomatic.php', array(&$this, 'activate'));                # Plugin activated
    add_action('deactivate_wp-o-matic-orig/wpomatic.php', array(&$this, 'deactivate'));            # Plugin deactivated
