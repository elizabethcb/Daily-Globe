...
$cas_text = array( "bmw", "boating", "daily", "cheese", "coffee", "diy", "dogs", "fishing", "golf", 
"hair", "hunting", "iditarod", "ipad", "quilting", "scrapbook", "surfing", "tattoo", "travel", 
"wedding", "wine", "women", "yoga", "zoo", "news", "electronic", "excellent", "rambo", "dinghy", 
"madmax", "hexidecimal", "rabble", "badger", "fungus", "quasi", "chicken", "slate", "flamingo", 
"deltoid", "fissure", "kronkite", "facto", "figure", "newsstand", "totem", "serene", "peer", "happy", 
"accept", "noodle", "feudal", "endless", "void", "sonic", "orange", "hammer", "tension", "crispy", 
"albeit", "walter", "uber", "medkit", "flux", "cycle", "saturn", "apogee", "build", "memory", 
"totem", "daily", "focus", "wheeze", "globe", "slate"); // <-- This line should not be changed
...
if( isset( $_GET['antiselect'] ) )
{
	...
	$tmp2 = strlen( ABSPATH);
	$cas_message = "<small id='spam_statement'>To prove you're a person<br />(not a spam script)<br />type the security word shown in the picture.</small>";
	...
	class PeterAntiSpam
	{
		...
		{
			global $cas_forcereg, $user_ID, $cas_textcount, $cas_myurl, $cas_imgheight, $cas_imgwidth, $cas_limitcolor, $cas_manualinsert, $cas_borderclr, $cas_message;
			...
			echo( '<span><label for="securitycode">Anti-spam word: (Required)</label><em style="color:#FF0000;">*</em></span>'."\n\t\t\t\t" );
		...
		function comment_post( $incoming_comment )
		{
			...
			if( $cas_forcereg || ! isset( $user_ID ) )
			{
				...
				else
				{
					...
					{
						die( __('Error: Please enter the correct anti-spam word. Press the back button and try again.') );
					} else {
						unset( $matchthis );
					}
				}
