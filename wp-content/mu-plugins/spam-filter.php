...
//            'fucker',
    ...
    function init() {
        add_submenu_page('edit-comments.php', '', '', 10, __FILE__, array(&$this, 'spam_filter'));
        $this->version_check();
    }
    ...
    function comment_handler($comment=false) {
        ...
        if (!$text) {
            ...
            $die = true;
            $message = 'Sorry, your comment has been rejected because it contained several links starting with with http:// - this is a measure to protect edublogs users from comment spam, we apologies for the inconvenience. <br /><br />Please click back and delete the http:// elements of your comments.<br /><br />For example: "http://edublogs.org" should simply be "edublogs.org".';
