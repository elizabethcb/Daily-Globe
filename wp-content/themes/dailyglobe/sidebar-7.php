...
<div class="widget_bg">
	...
	<ul id="event-sidebar-list">
		...
		<li class="buzz-article-button"><a rel="nofollow" target="_blank" href="http://www.google.com/reader/link?url=http://www.campdx.com/<?php the_ID(); ?>&title=<?php the_title(); ?>"><img src="http://www.johnchow.com/images/buzz.png" alt="Buzz This" id="buzz"/></a></li>	
	</ul>
</div>
